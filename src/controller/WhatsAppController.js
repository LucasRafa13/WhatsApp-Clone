              ...
              contactEl.innerHTML = `
                            ...
                            <div class="_3j7s9">
                                <div class="_2FBdJ">
                                    ...
                                    <div class="_3Bxar">
                                        <span class="_3T2VG">${Format.fbTimeStampToTime(
    ...
    Message.getRef(this._activeContact.chatId)
      ...
      .onSnapshot(docs => {
        ...
        docs.forEach(docMsg => {
          ...
          if (
            !this._messagesReceived.filter(msg => {
              return msg === docMsg.id
            }).length
          ) {
          ...
          if (data.type === "contact") {
            messageEl.querySelector(".btn-message-send").on("click", e => {
              Chat.createIfNotExists(this._user.email, data.content.email).then(
                chat => {
  ...
  initEvents() {
    ...
    this.el.btnSendPicture.on("click", event => {
      ...
      picture.onload = () => {
        ...
        Base64.toFile(
          canvas.toDataURL(Base64.getMimeType(this.el.pictureCamera.src))
        ).then(file => {
          Message.sendImage(this._activeContact.chatId, this._user.email, file)
