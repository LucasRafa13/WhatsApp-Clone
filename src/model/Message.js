  ...
  getViewElement(me = true) {
    ...
    switch (this.type) {
                            ...
                            <div class="_3DZ69" role="button">
                                ...
                                <div class="_3a5-b">
                                    <div class="_1DZAH" role="button">
                                        <span class="message-time">${Format.fbTimeStampToTime(
                                          this.timeStamp
                                        )}</span>
                                    </div>
                                </div>
                    ...
                    <div class="_3_7SH _3qMSo">
                        <div class="KYpDv">
                            <div>
                                ...
                                <div class="_2TvOE">
                                    <div class="_1DZAH" role="button">
                                        <span class="message-time text-white">${Format.fbTimeStampToTime(
                                          this.timeStamp
                                        )}</span>
                                    </div>
                                </div>
      ...
      case "audio":
        ...
        element.querySelector(".message-audio-duration").innerHTML =
          Format.toTime(this.duration * 1000)
        ...
        audio.ontimeupdate = e => {
          ...
          element.querySelector(".message-audio-duration").innerHTML =
            Format.toTime(audio.currentTime * 1000)
    ...
    if (me) {
      ...
      if (this.type === "image") {
        element
          ...
          .querySelector("path").attributes.fill.nodeValue = "#FFF"
      }
    }
